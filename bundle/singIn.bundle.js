...
var deleteWarningAcceptPolicy = function () {
    var _a;
    (_a = document.querySelector('.warning_policy')) === null || _a === void 0 ? void 0 : _a.remove();
};
...
var authWithGoogle = function () {
    app_1["default"].auth().signInWithPopup(provider).then(function (res) {
        var activeUserInfo = [];
        var userInformation = {
...
var checkMarkCheckBox = function () {
    if (document.querySelector('.warning_policy'))
        return;
...
/******/ })()
;
//# sourceMappingURL=singIn.bundle.js.map